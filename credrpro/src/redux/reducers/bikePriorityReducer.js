...
export default function priorityListReducer(state = intialState, action) {

  switch (action.type) {
    case GET_BIKE_PRIORITY.REQUEST:
      return getNewState(state, { isLoading: true })

    case GET_BIKE_PRIORITY.SUCCESS:
    ...
    case GET_BIKE_PRIORITY.FAILURE:
      const { error } = action.payload
      return getNewState(state, { error, ...intialState })

    case GET_BIKE_PRIORITY.RESET:
      return intialState
