...
class PaperReceivedTab extends Component {
  state = {
    currentTab: 0,
    imageurls: [],
    currentIndex: 0,
  ...
  updatePaperDocPayload = () => {
    ...
    const { dispatch } = this.props
    const payload = { leadId: this.props.match.params.leadId, ptStatus: 'DELIVERED', customerMobileNumber: Data.customerMobileNumber, ptCurrentStage: 4, imageUrl: imageURLS, customerName: Data.customerName, cityName: Data.cityName }
          ...
          !qcBikeDetails.length ? <NoResultsFound /> :
            < div className="tab-container" >
              ...
              >
                ...
                <Tab label="Proof of Delivery" className="tab-style" {...this.tabProps(4)} />
              </Tabs>
              {
              ...
              }
              {
                <TabPanel value={currentTab} index={qcBikeDetails.length + 1}>
                  <h1 className="tab-heading">Proof of Delivery Details</h1>
                  <div className="row">
...
export default connect()(PaperReceivedTab)