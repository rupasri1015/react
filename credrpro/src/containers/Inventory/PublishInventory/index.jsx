...
class AcceptRejectInvetory extends Component {
  ...
  unPublishInventory = () => {
    ...
    dispatch(showLoader())
    const payload = { inventoryType: 'STORE', status: 'UNPUBLISHED' }
  ...
  render() {
    ...
    return (
      <Fragment>
        <h3> Publish Inventory Details </h3>
        <InventoryFilters
...
export default connect(state => ({ page: state.publishInventory.page }))(AcceptRejectInvetory)