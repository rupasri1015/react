...
class PaymentAwaitingFilters extends Component {
    ...
    return (
      <div className='pending-inventory-filter-container mt-3'>
        ...
        <div className="from-date mr-2">
          <Dropdown
            className="dropdown-wraper"
            options={[{ label: 'Assigned date', value: 'Assigned Date' }, { label: 'Payment Date', value: 'Payment Date' }]}
...
export default withRouter(connect(mapStateToProps)(PaymentAwaitingFilters))
