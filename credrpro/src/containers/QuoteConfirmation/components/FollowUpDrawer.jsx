...
class FollowupDrawer extends Component {
    ...
    render() {
        const { drawer, open, confirmList, rowInfo, historyData, openForm } = this.props
            ...
            <div className={drawer}>
                ...
                <Grid fluid>
                    <Row gutter={45} style={{ marginTop: '20px' }}>
                        ...
                        {
                            // historyData.leadCallHistoryList?.length &&
                            <Col sm={12} className='paddingDiy1'>
                                <button style={{ padding: '9px 14px', backgroundColor: '#D92128', color: '#fff', borderRadius: '4px', fontFamily: 'ProximaNovaSemibold', fontSize: '14px' }} onClick={this.handleDrop}>
                                    Mark as Drop
                                </button>
                            </Col>
                        }
                        ...
                        <Col style={{ marginBottom: '30px' }}>
                            ...
                            <Row className='drawerWrap' style={{ marginLeft: '16px', marginRight: '16px' }}>
                                ...
                                <Col sm={17} style={{ paddingTop: '6px' }}>
                                    <p style={{ fontSize: '11px', margin: '0px', backgroundColor: '#3499E3', color: '#ffffff', textAlign: 'center', borderRadius: '9px', padding: '3px', width: '100%', maxWidth: '80px' }}> Follow Up </p>
                                </Col>
                                <Col style={{ paddingTop: '6px' }}>
                                    <p style={{ fontFamily: 'ProximaNovaSemibold', fontSize: '11px', paddingLeft: '5px', paddingRight: '5px' }}>Follow up Reason</p>
                                    {
                                ...
                                <Col style={{ paddingTop: '6px' }}>
                                    <p style={{ fontFamily: 'ProximaNovaSemibold', fontSize: '11px', paddingLeft: '5px', paddingRight: '5px' }}>Follow up Date & Time</p>
                                    {
...
export default connect()(FollowupDrawer)