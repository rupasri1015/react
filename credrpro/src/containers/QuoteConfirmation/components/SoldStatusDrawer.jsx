...
class SoldStatusDrawer extends Component {
    ...
    render() {
        const { drawer, open, confirmList, rowInfo, historyData } = this.props
                        ...
                        <Col style={{ marginBottom: '30px' }}>
                            ...
                            <Row className='drawerWrap' style={{ marginLeft: '16px', marginRight: '16px' }}>
                                ...
                                <Col sm={17} style={{ paddingTop: '6px' }}>
                                    <p style={{ fontSize: '11px', margin: '0px', backgroundColor: '#4DBD74', color: '#ffffff', textAlign: 'center', borderRadius: '9px', padding: '3px', width: '100%', maxWidth: '80px' }}>Sold</p>
                                </Col>
                                <Col style={{ paddingTop: '6px' }}>
                                    <p style={{ fontFamily: 'ProximaNovaSemibold', fontSize: '11px', paddingLeft: '5px', paddingRight: '5px' }}>Sold Date & Time</p>
                                    {
...
export default connect()(SoldStatusDrawer)