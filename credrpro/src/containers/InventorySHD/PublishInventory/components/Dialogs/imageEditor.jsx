...
import '../../../AcceptReject/components/Dialogs/toastUI.scss'
...
export default function ImageEditorDialog({ isImageOpen, closeDrawer, closeModal, img, currentIndex, handleEnhancedImages, uploadImage }) {
    let subImgUrl = img.slice(0, 4) + img.slice(5, img.length)
    ...
    const list = (anchor) => (
        <>
            <div className='tui-image-editor-header-buttons'>
                <button className='tui-image-editor-download-btn closeBtn' onClick={closeDrawer} >Close</button>
