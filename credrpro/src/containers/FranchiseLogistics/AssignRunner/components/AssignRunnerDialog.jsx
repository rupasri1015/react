...
const FranchiseAssignRunnerDialog = ({ runners, runner, open, onClose, onAssignRunner, handleSubmit }) => {
          ...
          >
            {
              ...
              runners.map(runnerDetails => <MenuItem value={runnerDetails.id} key={runnerDetails.id}>{runnerDetails.name}</MenuItem>)
            }
          </Field>
          <Field
            name="mode"
