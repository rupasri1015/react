...
class Commission extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({ commission: viewData.credrPlusAmount })
        this.setState({ extra_com: viewData.commission })
        this.setState({ traffic_challan_shd: viewData.userTrafficChalan })
        this.setState({ traffic_challan: viewData.userTrafficChalan })
        this.setState({ hp_rto: viewData.hp_rto })
        this.setState({ hp_rto_shd: viewData.hp_rto })
        ...
        this.setState({ rto: viewData.shdTrafficChalan })
        this.setState({ trafficChallan: viewData.userTrafficChalan, cityCommission: viewData.cityLevelCommission })
        let initialData = { ...viewData,userHpRtoCharges:viewData.hp_rto,shdHpRtoCharges:viewData.hp_rto ,commission: viewData.credrPlusAmount, userTrafficChalan: viewData.userTrafficChalan, shdTrafficChalan: viewData.userTrafficChalan }
    ...
    totalDeductionCom = () => {
        const { cityCom, extra_com, traffic_challan, hp_rto, noc, vehicle, misc, rto, trafficChallan, cityCommission,commission } = this.state
        let totalAmt = 0
        // if (cityCom)
        ...
        if (cityCommission)
            totalAmt = totalAmt + Number(cityCommission)
        return totalAmt
    }
    totalDeductionShd = () => {
        const { traffic_challan_shd, hp_rto_shd, noc_shd, vehicle_shd, misc_shd, rto, trafficChallan,extra_com } = this.state
        let totalAmt = 0
        if (traffic_challan_shd)
            totalAmt = Number(traffic_challan_shd)
        if (hp_rto_shd)
            totalAmt = totalAmt + Number(hp_rto_shd)
        // if (noc_shd)
    ...
    render() {
        ...
        const { chars_left, precms, showErr, disableForm } = this.state
                            ...
                            <CardBody>
                                <table className="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr >
                                            ...
                                            <td  >
                                                <Field
                                                    name="shdTrafficChalan"
                                                    component={this.DisabledTextInput}
                                                    variant="outlined"
                                                    disabled={true}
                                                    normalize={onlyNumber}
                                                    // onChange={(e, newval, preval) => { this.setState({ traffic_challan_shd: newval });  }}
                                                    style={{ width: '300px' }}
                                                />
                                            </td>
                                            <td  >
                                ...
                                {/* <Row style={{ paddingLeft: '15px' }}>
                                    ...
                                    <Col className="rowstyle" style={{ marginTop: "-15px" }} md={3}>
                                        <Field
                                            name="userTrafficChalan"
                                            component={this.TextInput1}
                                            variant="outlined"
                                            disabled={disableForm}
                                            normalize={onlyNumber}
                                            // onChange={(e, newval, preval) => { this.setState({ traffic_challan: newval }); this.checkTc(newval) }}
                                            style={{ width: '300px' }}
                                        />
                                    </Col>
                                </Row>
                                <Row style={{ paddingLeft: '15px' }}>
                                    ...
                                    <Col className="rowstyle" style={{ marginTop: "-15px" }} md={3}>
                                        <Field
                                            ...
                                            disabled={disableForm}
                                            normalize={onlyNumber}
                                            // onChange={(e, newval, preval) => { this.setState({ hp_rto: newval }); this.checkHp(newval) }}
                                            style={{ width: '300px' }}
                                        />
                                    </Col>
                                </Row> */}
                        ...
                        <Card style={{ border: "1px solid #DCDCDC", borderRadius: '0%' }}>
                            ...
                            <CardBody>
                                ...
                                <Row style={{ paddingLeft: '15px' }}>
                                    ...
                                    <Col className="rowstyle" md={4}>
                                        Receiving from Channel Partner
                                    </Col>
                                </Row>
                                {/* <Row style={{ paddingLeft: '15px' }}>
                                    <Col className="rowstyle" md={4}>
