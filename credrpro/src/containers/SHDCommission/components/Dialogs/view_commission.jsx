...
class ViewCommission extends Component {
    ...
    totalDeductionCom = () => {
        const { cityCom, extra_com, traffic_challan, hp_rto, noc, vehicle, misc, docQc2 } = this.state
        let totalAmt = 0
        if (cityCom)
    ...
    totalDeductionShd = () => {
        const { traffic_challan_shd, hp_rto_shd, noc_shd, vehicle_shd, misc_shd, docQc2 } = this.state
        let totalAmt = 0
                                ...
                                <Row style={{ paddingLeft: '15px' }}>
                                    ...
                                    <Col className="rowstyle" style={{ marginTop: "-15px" }} md={3}>
                                        <Field
                                            ...
                                            onChange={(e, newval, preval) => { this.setState({ extra_com: newval }); }}
...
ViewCommission = connect(mapStateToProps)(withRouter(ViewCommission))

export default reduxForm({
    form: 'view_commission_form',
})(ViewCommission)
